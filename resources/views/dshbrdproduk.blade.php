...
<body>
    ...
    <div class="content">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <a class="navbar-brand" href="#" style="font-weight: bold">DAFTAR PRODUK</a>
        ...
        <a href="/produk/create" class="btn btn-secondary btn-lg" style="height: 35px; font-size: small;">Tambah Produk</a>
