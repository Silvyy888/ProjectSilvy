...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/troli"><i class="fi fi-rr-shopping-cart" style="margin-top: 10px"></i></a>
                    </li>
                    <li class="nav-item">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="#">Perawatan Bayi</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#">Perlengkapan Mandi</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">Peralatan Bayi</a>
                    </li>
                    <li class="nav-item">
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link" href="/lgot"><i class="fi fi-br-sign-out-alt"></i> LogOut</a>
                </li>
            </ul>
        </div>
    </nav>
    ...
    <!-- Hero Section -->
    {{-- <header class="hero text-white text-center py-5" style="background-color: palevioletred">
        <div class="container">
            <h1 class="display-4">Little Hugs</h1>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="#" class="btn btn-primary" style="margin-left: 40px">Beli Sekarang</a><a href="#" class="btn btn-danger" style="margin-left: 10px">Tambah Troli</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 mb-4">
    ...
    <footer class="text-center py-3" style="background-color: whitesmoke; margin-top: 50px">
        <div class="container">
            <h1 style="color: black; font-size: 35px; margin-left: -90%; margin-top: 20px">BABY</h1>
            <h1 style="color: black; font-size: 35px; margin-left: -80%">EQUIPMENT</h1>
