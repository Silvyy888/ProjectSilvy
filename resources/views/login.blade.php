...
<body>
    <nav class="navbar navbar-expand-sm navbar-dark" style="background-color: rgb(255, 62, 94); font-weight: bold">
        <div class="container-fluid">
            <a href="#" class="navbar-brand">LittleHugs</a>
        </div>
    </nav>
    <div class="container">
                ...
                <div class="card mt-5">
                    ...
                    <div class="card-body">
                        <form method="post" action="/auth">
                            ...
                            <button type="submit" class="btn btn-danger btn-block mt-3 w-100">Masuk</button>
                            <div class="card-footer text-center">
                                <a href="#" style="font-size: small">Forgot the password?</a>
                            </div>
                        </form>
                    </div>
                </div>
